...
<body>
    ...
    <div class="main--content">
                ...
                <table>
                    <thead>
                        <tr colspan="10">
                            ...
                            <th>Acciones</th>
                            <th><a href="rcosecha.html">Agregar</a></th>
                        </tr>
                    </thead>
                    <?php
                    $sql = "SELECT * from cosechas";
                    ...
                    while ($mostrar = mysqli_fetch_array($resultado)) {
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <?php echo $mostrar['id_cosecha'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['mcosecha'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['tcosecha'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['crecogida'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['cperdida'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['fechacosecha'] ?>
                                </td>
                                <td><button>
                                        <form action="editarcosechas.php">
                                            <a
                                                href="editarcosechas.php?id_cosecha=<?php echo $mostrar['id_cosecha'] ?>&mcosecha=<?php echo $mostrar['mcosecha'] ?>&tcosecha=<?php echo $mostrar['tcosecha'] ?>&crecogida=<?php echo $mostrar['crecogida'] ?>&cperdida=<?php echo $mostrar['cperdida'] ?>&fechacosecha=<?php echo $mostrar['fechacosecha'] ?>"><i
                                                    class="fas fa-edit"></i></a>
                                        </form>
                                    </button> o <button>
                                        <form action="ecosecha.php" method="GET">
                                            <a
                                                href="ecosecha.php? id_cosecha=<?php echo $mostrar['id_cosecha'] ?>"><i
        ...
        <div class="tabular--wrapper">
            ...
            <div class="table-container">
               <img  class="ki" src="img/3.jpeg" alt="">
               <img  class="ki" src="img/33.jpeg" alt="">
            </div>
        </div>
