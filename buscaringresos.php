...
<body>
    ...
    <div class="main--content">
        ...
        <div class="tabular--wrapper">
            <h3 class="main--title">INGRESOS</h3>
            <div class="table-container">
                <table>
                    ...
                    <?php
                        $sql = "SELECT ningreso, cprecio, descripcion, fechaing, mpago FROM ingresos where ningreso like '$buscar' '%' or fechaing like '$buscar' '%' or mpago like '$buscar' '%' order by ningreso desc";
                        $resultado = mysqli_query($conexion, $sql);
                        while ($mostrar = mysqli_fetch_array($resultado)){
                    ?>
                        <tbody>
                            <tr>
                                <td><?php echo $mostrar['ningreso']?></td>
                                <td><?php echo $mostrar['cprecio']?></td>
                                <td><?php echo $mostrar['descripcion']?></td>
                                <td><?php echo $mostrar['fechaing']?></td>
                                <td><?php echo $mostrar['mpago']?></td>
                                <td><button>
                                    <form action="editaringresos.php">
                                    <a href="editaringresos.php?ningreso=<?php echo $mostrar['ningreso']?>&cprecio=<?php echo $mostrar['cprecio']?>&descripcion=<?php echo $mostrar['descripcion']?>&fechaing=<?php echo $mostrar['fechaing']?>&mpago=<?php echo $mostrar['mpago']?>"><i
                                                    class="fas fa-edit"></i></a>
                                    </form>
                                </button> o <button>
                                    <form action="eingreso.php" method="GET">
                                        <a href="eingreso.php? ningreso=<?php echo $mostrar ['ningreso']?>"><i
            ...
            <div class="table-container">
                <table>
                    ...
                    ?>
                        <tbody>
                            <tr>
                                <td><?php echo $mostrar['negreso']?></td>
                                <td><?php echo $mostrar['cprecio']?></td>
                                <td><?php echo $mostrar['descripcion']?></td>
                                <td><?php echo $mostrar['fechaeg']?></td>
                                <td><?php echo $mostrar['mpago']?></td>
                                <td><button>
                                    <form action="editaregresos.php">
                                    <a href="editaregresos.php?negreso=<?php echo $mostrar['negreso']?>&cprecio=<?php echo $mostrar['cprecio']?>&descripcion=<?php echo $mostrar['descripcion']?>&fechaeg=<?php echo $mostrar['fechaeg']?>&mpago=<?php echo $mostrar['mpago']?>">Editar</a>
                                    </form>
                                </button> o <button>
                                    <form action="eegreso.php" method="GET">
                                        <a href="eegreso.php? id_egre=<?php echo $mostrar['id_egre']?>">Eliminar</a>
                                    </form>
                                </button></td>
                                <td><button>
                                    <form action="regreso.html" method = "POST">
                                        <a href="regreso.html">Agregar</a>
                                    </form>
                                </button></td>
                            </tr>
                        </tbody>
