        ...
        <div class="tabular--wrapper">
            ...
            <div class="table-container">
                <table>
                    ...
                    <?php
                        $sql = "SELECT negreso, cprecio, descripcion, fechaeg, mpago FROM egresos where fechaeg like '$buscar' '%' or negreso like '$buscar' '%' or mpago like '$buscar' '%' order by negreso desc";
                        $resultado = mysqli_query($conexion, $sql);
                        while ($mostrar = mysqli_fetch_array($resultado)){
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td><button>
                                    ...
                                    <a href="editaregresos.php?negreso=<?php echo $mostrar['negreso']?>&cprecio=<?php echo $mostrar['cprecio']?>&descripcion=<?php echo $mostrar['descripcion']?>&fechaeg=<?php echo $mostrar['fechaeg']?>&mpago=<?php echo $mostrar['mpago']?>"><i
                                                    class="fas fa-edit"></i></a>
                                    </form>
                                </button> o <button>
                                    <form action="eegreso.php" method="GET">
                                        <a href="eegreso.php? negreso=<?php echo $mostrar['negreso']?>"><i
                                                    class="fas fa-trash"></i></a>
                                    </form>
                                </button></td>
                                <td><button>
