...
<body>
    ...
    <div class="main--content">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Almacén</th>
                            <th>Acciones</th>
                            <th><a href="rinventario.html">Agregar</a></th>
                        </tr>
                    </thead>
                    <?php
                    ...
                    while ($mostrar = mysqli_fetch_array($resultado)) {
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <?php echo $mostrar['id_inv'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['nproducto'] ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php echo $mostrar['nalmacen'] ?>
                                </td>
                                <td><button>
                                        <form action="editarinventario.php">
                                            <a
                                                href="editarinventario.php?id_inv=<?php echo $mostrar['id_inv'] ?>&nproducto=<?php echo $mostrar['nproducto'] ?>&stock=<?php echo $mostrar['stock'] ?>&descripcion=<?php echo $mostrar['descripcion'] ?>&nalmacen=<?php echo $mostrar['nalmacen'] ?>"><i
        ...
        <div class="tabular--wrapper">
            ...
            <div class="table-container">
               <img  class="ki" src="img/2.jpeg" alt="">
               <img  class="ke" src="img/22.jpeg" alt="">
            </div>
        </div>
