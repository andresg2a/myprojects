...
<body>
    ...
    <div class="main--content">
        ...
        <div class="tabular--wrapper">
            <h3 class="main--title">Datos de trabajadores</h3>
            <div class="table-container">
                <table>
                    ...
                    <?php
                        $sql = "SELECT idtrabajador, nom, apell, genero, fcontrato, mpago, telefono FROM dt where nom like '$buscar' '%' or genero like '$buscar' '%' or idtrabajador like '$buscar' '%' or mpago like '$buscar' '%' order by idtrabajador desc";
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $mostrar['apell']?></td>
                                <td><?php echo $mostrar['genero']?></td>
                                <td><?php echo $mostrar['fcontrato']?></td>
                                <td><?php echo $mostrar['mpago']?></td>
                                <td><?php echo $mostrar['telefono']?></td>
                                <td><button>
                                    <form action="editartrabajador.php">
                                    <a href="editartrabajador.php?idtrabajador=<?php echo $mostrar['idtrabajador']?>&nom=<?php echo $mostrar['nom']?>&apell=<?php echo $mostrar['apell']?>&genero=<?php echo $mostrar['genero']?>&fcontrato=<?php echo $mostrar['fcontrato']?>&mpago=<?php echo $mostrar['mpago']?>&telefono=<?php echo $mostrar['telefono']?>"><i
