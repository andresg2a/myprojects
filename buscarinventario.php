...
<body>
    ...
    <div class="main--content">
        <div class="header--wrapper">
            ...
            <div class="user--info">
            <form action="buscarinventario.php" method= "post">
        ...
        <div class="tabular--wrapper">
            ...
            <div class="table-container">
                <table>
                    ...
                    <?php
                        $sql = "SELECT id_inv, nproducto, stock, descripcion, nalmacen FROM inventario where nproducto like '$buscar' '%' or descripcion like '$buscar' '%' or nalmacen like '$buscar' '%' order by id_inv desc";
                        $resultado = mysqli_query($conexion, $sql);
                        while ($mostrar = mysqli_fetch_array($resultado)){
                    ?>
                        <tbody>
                            <tr>
                                <td><?php echo $mostrar['id_inv']?></td>
                                <td><?php echo $mostrar['nproducto']?></td>
                                <td><?php echo $mostrar['stock']?></td>
                                <td><?php echo $mostrar['descripcion']?></td>
                                <td><?php echo $mostrar['nalmacen']?></td>
                                <td><button>
                                    <form action="editarinventario.php">
                                    <a href="editarinventario.php?id_inv=<?php echo $mostrar['id_inv']?>&nproducto=<?php echo $mostrar['nproducto']?>&stock=<?php echo $mostrar['stock']?>&descripcion=<?php echo $mostrar['descripcion']?>&nalmacen=<?php echo $mostrar['nalmacen']?>"><i
                                                    class="fas fa-edit"></i></a>
                                    </form>
                                </button> o <button>
                                    <form action="einventario.php" method = "GET">
                                        <a href="einventario.php? id_inv=<?php echo $mostrar ['id_inv']?>"><i
                                                    class="fas fa-trash"></i></a>
                                    </form>
                                </button></td>
                                <td><button>
                                    <form action="rinventario.html" method = "POST">
                                        <a href="rinventario.html"><i class="fa-solid fa-plus"></i></a>
                                    </form>
                                </button></td>
                            </tr>
                        </tbody>
