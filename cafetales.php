                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Acciones</th>
                            <th><a href="rcafetal.html">Agregar</a></th>
                        </tr>
                    </thead>
                    <?php
                    $sql = "SELECT * from cafetales";
                    ...
                    while ($mostrar = mysqli_fetch_array($resultado)) {
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <?php echo $mostrar['id_cafetal'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['ubicacion'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['area'] ?> m^2
                                </td>
                                <td>
                                    <?php echo $mostrar['tcafe'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['fecha'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['plantas'] ?>
                                </td>
                                <td><button>
                                        <form action="editarcafetales.php">
                                            <a
                                                href="editarcafetales.php?id_cafetal=<?php echo $mostrar['id_cafetal'] ?>&ubicacion=<?php echo $mostrar['ubicacion'] ?>&area=<?php echo $mostrar['area'] ?>&tcafe=<?php echo $mostrar['tcafe'] ?>&fecha=<?php echo $mostrar['fecha'] ?>&plantas=<?php echo $mostrar['plantas'] ?>"><i
                                                    class="fas fa-edit"></i></a>
                                        </form>
                                    </button> o <button>
                                        <form action="ecafetal.php" method="GET">
                                            <a
                                                href="ecafetal.php? id_cafetal=<?php echo $mostrar['id_cafetal'] ?>"><i
